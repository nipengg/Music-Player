                ...
                <Grid item xs={12} align="center">
                    <Collapse in={this.state.errorMsg != '' || this.state.successMsg != ''}>
                        {this.state.successMsg != '' ?
                            (<Alert variant="filled" severity='success' onClose={() => {this.setState({successMsg: ''})}}>{this.state.successMsg}</Alert>) :
                            (<Alert variant="filled" severity='error' onClose={() => {this.setState({errorMsg: ''})}}>{this.state.errorMsg}</Alert>)
                        }
                    </Collapse>
                </Grid>
                <Grid item xs={12} align="center">
